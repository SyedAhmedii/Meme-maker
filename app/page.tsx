...
import MemeImage from "./public/Assets/Scenery.png"


const App = () => {
  return (
    <>
      <div className='w-full min-h-[90vh] flex justify-center items-center bg-blue-300'>
        <div className='w-full max-w-[50%] min-h-[90vh] flex flex-col justify-center items-start px-20'>
          ...
          <button className='rounded-xl p-3 text-2xl font-semibold mt-5 text-white'>
        ...
        <div className='w-full max-w-[50%] min-h-[70vh] flex justify-center items-center'>

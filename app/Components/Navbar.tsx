...
const Navbar = () => {
    ...
    return (
        <>
            <div className="navbar bg-purple bg-fixed flex justify-between items-center lg:px-10 xl:px-20 bg-slate-400">
                <div>
                    <Link className="btn btn-ghost text-xl lg:text-2xl font-bold" href={"/"}>Meme Maker</Link>
                </div>
